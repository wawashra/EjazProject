...
import com.ejazbzu.repository.TagRepository;
import com.ejazbzu.service.TagService;
import com.ejazbzu.service.dto.TagDTO;
import com.ejazbzu.service.mapper.TagMapper;
import com.ejazbzu.web.rest.errors.ExceptionTranslator;
import com.ejazbzu.service.dto.TagCriteria;
import com.ejazbzu.service.TagQueryService;
...
public class TagResourceIT {
    ...
    @Test
    @Transactional
    public void getAllTagsByDocumentsIsEqualToSomething() throws Exception {
        // Initialize the database
        tagRepository.saveAndFlush(tag);
        Document documents = DocumentResourceIT.createEntity(em);
        em.persist(documents);
        em.flush();
        tag.addDocuments(documents);
        tagRepository.saveAndFlush(tag);
        Long documentsId = documents.getId();

        // Get all the tagList where documents equals to documentsId
        defaultTagShouldBeFound("documentsId.equals=" + documentsId);

        // Get all the tagList where documents equals to documentsId + 1
        defaultTagShouldNotBeFound("documentsId.equals=" + (documentsId + 1));
    }
