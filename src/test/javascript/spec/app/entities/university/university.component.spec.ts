...
import { UniversityComponent } from 'app/entities/university/university.component';
...
describe('Component Tests', () => {
  describe('University Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.universities && comp.universities[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
